//Recomendo Não Mudar Nada Da Aqui Pra Baixo
//Se Não O Selfdiv Para De Vez Pois Està Conectado A Uma API

//Selfdiv Necxself Não Kiba Não Comedia

console.log('=========================================================');
console.log('   ▀▀▀▀█ █▀▀ █░░░█ █▀▄ ');
console.log('     ░▄▀▀░ █▀▀ █░█░█ █░█    ');
console.log('     ▀▀▀▀▀ ▀▀▀ ░▀░▀░ ▀▀░   ');
console.log('  Brota discord: https://discord.gg/XBq3FgmqK8  ');
console.log('  Brota https://discord.gg/XBq3FgmqK8');
console.log('=========================================================');
